...
/**
 * Servlet implementation class PreLoadData
 */
@WebServlet("/LoadData")
public class PreLoadData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("###### pre load being executed #######");
		...
		Map<Integer,Account> receivedAccounts= new AccountDaoDB().findAllAccounts();
		if(receivedAccounts==null) {
			Connection con=DBUtil.getH2Connection();
			DBUtil.createTablesAndSequences(con);
			System.out.println("## Connection Established, Tables & Sequences are created ##");
			...
			System.out.println("*** Data Cleared - Reload the data ***");
			Connection con=DBUtil.getH2Connection();
			DBUtil.createTablesAndSequences(con);
			System.out.println("## Connection Established, Tables & Sequences are created ##");

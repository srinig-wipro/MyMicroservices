	...
	<div class="card">
	  ...
	  <div class="card-body">
	   <div style="float: right">
				   <a class="btn btn-info" href="AccountServlet">Create New Account</a>
				   <a class="btn btn-info" href="GetAccountBalance">Search Account by ID</a>
				   <a class="btn btn-info" href="DisplayAccountsORCustomServlet">Display all Accounts or customers</a>
				   <a class="btn btn-info" href="FundTransferServlet">Transfer Funds from one account to another</a>
	   </div>
		<br/><br/>

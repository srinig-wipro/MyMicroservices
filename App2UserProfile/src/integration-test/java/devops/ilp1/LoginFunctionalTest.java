...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        ...
        pass.sendKeys("1234");
        button.click();
        assertTrue(driver.getPageSource().contains("Success4444Page"));
	}
	...
	public void loginFail() {
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("Invalid username or 3333password, Please try again with valid"));
	}
